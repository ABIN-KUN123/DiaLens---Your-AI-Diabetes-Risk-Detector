  ...
  return (
    <div className="min-h-screen bg-[#F4F8FF] text-slate-900 font-sans selection:bg-blue-100">
      <div className="flex">
        ...
        {/* Panggil komponen Sidebar terpusat di sini */}
        <Sidebar />
        ...
        <div className="md:pl-64 pt-20 md:pt-0 w-full">
          <main className="p-8 max-w-7xl mx-auto space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <StatCard title="Total Skrining" value={screeningData.totalScreening} desc="Jumlah akumulasi semua pemeriksaan yang tersimpan dalam riwayat medis Anda." icon={TrendingUp} iconBg="bg-amber-500" gradientBg="from-amber-50/60 to-white" />
              <StatCard title="Indeks Massa Tubuh" value={screeningData.lastBmi} desc="Hasil BMI terbaru yang dihitung dari entri berat dan tinggi badan terakhir." icon={User} iconBg="bg-sky-500" gradientBg="from-sky-50/60 to-white" />
              <StatCard title="Status Risiko AI" value={screeningData.lastRisk} desc="Kategori risiko terakhir yang dihasilkan oleh kalkulator AI." icon={Zap} iconBg={screeningData.lastRisk === 'Risiko Tinggi' ? 'bg-rose-500' : screeningData.lastRisk === 'Risiko Sedang' ? 'bg-amber-500' : 'bg-emerald-500'} gradientBg="from-purple-50/60 to-white" />
            </div>
